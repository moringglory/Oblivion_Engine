...
public class PayItemFactory extends UnitBlock{

        public float constructTime = 60 * 2;
        public Seq<UnitType[]> upgrades = new Seq<>();
        public int[] capacities = {};

        public PayItemFactory(String name){
            super(name);
            regionRotated1 = 1;
            regionRotated2 = 2;
            commandable = true;
            ...
            configurable = true;
            config(UnitCommand.class, (mindustry.world.blocks.units.Reconstructor.ReconstructorBuild build, UnitCommand command) -> build.command = command);
            configClear((mindustry.world.blocks.units.Reconstructor.ReconstructorBuild build) -> build.command = null);
        }
    ...
    @Override
        ...
        public void setBars(){
            ...
            addBar("progress", (mindustry.world.blocks.units.Reconstructor.ReconstructorBuild entity) -> new Bar("bar.progress", Pal.ammo, entity::fraction));
            addBar("units", (mindustry.world.blocks.units.Reconstructor.ReconstructorBuild e) ->
                    new Bar(
